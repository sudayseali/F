    ...
    <div className="space-y-6">
      <header className="flex items-center space-x-4">
        <button 
          ...
          className="p-2 bg-[#111218] rounded-full shadow-sm hover:bg-[#0b0c10] transition-colors"
        >
          <ArrowLeft className="w-5 h-5 text-gray-400" />
        </button>
        <h1 className="text-xl font-bold text-white line-clamp-1">Task Verification</h1>
      </header>
      ...
      <div className="bg-[#111218] rounded-2xl border border-gray-800 shadow-sm overflow-hidden">
        <div className="p-6 border-b border-gray-800">
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <h2 className="text-2xl font-bold text-white leading-tight">Join Telegram Crypto Group</h2>
            </div>
          ...
          <div className="flex flex-wrap gap-3">
             <div className="flex items-center space-x-2 text-sm text-gray-400 bg-[#0b0c10] px-3 py-1.5 rounded-lg border border-gray-800">
        ...
        <div className="p-6 bg-[#0b0c10]">
          <h3 className="text-sm font-bold uppercase tracking-wider text-gray-400 mb-4">Instructions</h3>
          <ol className="space-y-4 mb-8">
            <li className="flex space-x-3 text-sm text-gray-300">
          ...
          {status === 'success' ? (
             <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-6 text-center text-emerald-400">
                ...
                <h3 className="text-lg font-bold mb-1 text-white">Submission Received!</h3>
                <p className="text-sm opacity-90 text-gray-300">Your proof is under review. The reward will be added to your wallet within 24 hours.</p>
             </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4 bg-[#111218] p-5 rounded-2xl border border-gray-800">
              <h3 className="text-base font-bold text-white border-b border-gray-800 pb-3">Submit Proof</h3>
              ...
              <div>
                <label className="block text-xs font-semibold uppercase tracking-wider text-gray-400 mb-1.5">Your Telegram Username</label>
                <input 
                  type="text" 
                  required
                  placeholder="@username" 
                  className="w-full px-4 py-2.5 rounded-xl border border-gray-800 bg-[#0b0c10] text-gray-200 focus:bg-[#111218] focus:outline-none focus:border-amber-500 transition-all text-sm placeholder:text-gray-600"
                />
              </div>

              <div>
                <label className="block text-xs font-semibold uppercase tracking-wider text-gray-400 mb-1.5">Screenshot Proof</label>
                ...
                {previewUrl ? (
                  <div className="relative border border-gray-800 rounded-xl overflow-hidden bg-[#0b0c10] aspect-video flex items-center justify-center">
                  ...
                  <label 
                    ...
                    className="border-2 border-dashed border-gray-800 rounded-xl p-6 flex flex-col items-center justify-center text-gray-400 hover:bg-[#0b0c10] hover:border-amber-500 hover:text-amber-500 transition-colors cursor-pointer group"
                  >
